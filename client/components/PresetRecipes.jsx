  ...
  return (
    <>
      <div style={{ backgroundColor: 'pink' }}>
        <h1 id="font">
          Under maintenance. For now enjoy this cool back button and use your imagination.
        </h1>
      ...
      {list !== [] &&
        list.map((ele, i) => (
          <div className="recipes hover">
            <h2 id="font" className="center" key={i}>
              {ele.label}
            </h2>
            ...
            <div className="info">
              <a className="linkfont" href={ele.url} target="_blank" rel="noopener noreferrer">
                Read More
              </a>
              ...
              <button
                id="font"
                className="buttons"
                onClick={() => nutrFactsSetShow(!nutrFactsShow)}
              >
                Nutritional Facts
              </button>
